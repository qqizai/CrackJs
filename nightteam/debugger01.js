//如果关键参数 arg1 为 5D6DBFF4776ED19E013868C0663AC4A6FD3C2FEB，那么 set 的关键 cookie arg2 是多少？答案：a3c0e93f77bfd38a6be3e0d72665bdfd2cead199
//arg1 = "D45FBC03F9FC0CDADC9001B4FD4F14479672E880"    e7148db89f11641df6da8d50f07e2d0ffcdf6db7
// desc坑：这里不能格式化代码，格式化的话，这里是会浏览器内存爆炸的，直接卡死，建议还是直接找到对应的加密位置后，直接将对应debugger函数置空即可

//法一：格式化后，即使将函数置空还是不能过了内存爆炸的关
...
//                     for (var _0x1a0f04 = 0x0, _0x18c94e, _0x41b2ff, _0xd79219 = 0x0, _0x5792f7 = ''; _0x41b2ff = _0xec6bb4['charAt'](_0xd79219++); ~_0x41b2ff && (_0x18c94e = _0x1a0f04 % 0x4 ? _0x18c94e * 0x40 + _0x41b2ff : _0x41b2ff,
//                     _0x1a0f04++ % 0x4) ? _0x5792f7 += String['fromCharCode'](0xff & _0x18c94e >> (-0x2 * _0x1a0f04 & 0x6)) : 0x0) {
...
//             (function() {}
//                 [_0x55f3('0x1d', 'CNUY')]((undefined + '')[0x2] + (!![] + '')[0x3] + ([][_0x55f3('0x1e', 'w8PR')]() + '')[0x2] + (undefined + '')[0x0] + (![] + [0x0] + String)[0x14] + (![] + [0x0] + String)[0x14] + (!![] + '')[0x3] + (!![] + '')[0x1])());
//         } else {
//             (function() {}
//                 ['constructor']((undefined + '')[0x2] + (!![] + '')[0x3] + ([][_0x55f3('0x1f', 'L$(D')]() + '')[0x2] + (undefined + '')[0x0] + (![] + [0x0] + String)[0x14] + (![] + [0x0] + String)[0x14] + (!![] + '')[0x3] + (!![] + '')[0x1])());
//         }
//         _0x355d23(++_0x450614);
//     }
//     try {
...
function reload(x) {debugger;setCookie("yemu", x);document.location.reload();}
