...
//获取随机指纹fp，目前发现通过率不大好，请使用下面第二个方法
function get_fp(){
...
function get_fp2() {
    ...
    navigator.maxTouchPoints = 0;//是否支持多点触控
    ...
    location.ancestorOrigins = new Object();
    location.href = "https://dun.163.com/trial/sense";
    location.origin = "https://dun.163.com";
    location.host = "dun.163.com";
    location.hostname = "dun.163.com";
    location.pathname = "/trial/sense";
    location.search = "";
    location.hash = "";
                ...
                !function() {
                    ...
                    !function() {
                        ...
                        !function() {
                            ...
                            function d(e) {//将 字符串e进行URL编码，然后再转换为ascii码，最后返回一个数组，一个字符串作为一个元素
                                if (null == e || void 0 == e)
                                    return e;
                            ...
                            function y(e, n) {//这里重点！将两个长度一样的数组，先使用下面的b函数，判断一下两个元素的范围，然后获取新的值，再进行异或，异或后的值传递到b函数再处理，然后在数组里面添加最后返回的值
                            ...
                            function m(i) {
                                ...
                                function a() {
                                    ...
                                    if (!t)
                                        return i;
                                    try {
                                        i.push(t[l[21]]())//获取支持WebGL 扩展的列表，可以写死为：
                                    } catch (o) {}
                                    try {
                                        i.push(f(t, n))
                                    } catch (a) {}
                                ...
                                function j() {//用于canvas生成一个图片
                                    try {
                                        var n = G[u[120]](s[66])//s[66]=canvas
                                            , i = n[s[171]](e[104])//获取2d指纹，n.getContext.2d
                                            , r = s[91];// "mwC nkbafjord phsgly exvt zqiu, ὠ tphst/:/uhbgtic.mo/levva"
                                ...
                                function h() {
                                    ...
                                    return [e.name, e.description, n].join("::")//s[75]="::"  */
                                        ...
                                        return [e.name, e.description, [e.type, e.suffixes].join("~")].join("::")//s[75]="::"
                                    ...
                                    // Chrome PDF Plugin::Portable Document Format::appli…lient::::application/x-nacl~,application/x-pnacl~

                                    // APlayer ActiveX hosting plugin::APlayer III ActiveX hosting plugin for Firefox::application/x-google-chrome-APlayer~
                                    // APlayer$ASUS Update::ASUS Update::application/x-google-chrome-ASUS~ASUS$Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf$YzPxEKa::5hCBdytPnSpMn3Rn4GG::Z3h~Gp$K::66XHCf::5wjt~5xHiERktFGFSBYT8teaZN5f8RfcdbaGW
                                    i.push(my_y2.join(";"));//u[9]=";"
                                    //目前发现i.join(";")值为：
                                    //第一个插件的信息;第二个插件的信息;....
                                    //然后，应该：从前面 n 数组里面检测对应的插件，如果有对应存在的话，就得少一个分号;  因为最后的是可能会检测这个长度的.

                                    // Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf,application/x-google-chrome-pdf~pdf$Chrome PDF Viewer::::application/pdf~pdf$Native Client::::application/x-nacl~,application/x-pnacl~;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    // i = "Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf,application/x-google-chrome-pdf~pdf$Chrome PDF Viewer::::application/pdf~pdf$Native Client::::application/x-nacl~,application/x-pnacl~;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
                                    // return i.join(";");//u[9]=";"
                                    return i;//u[9]=";"
                                }
                                function p() {
                                ...
                                this.get = function() {//原来 m.get(){}就是这个函数
                                    ...
                                    if (K) {
                                        var l;
                                        try {
                                            l = !!window[e[90]]//sessionStorage, true
                                        } catch (f) {
                                            l = !0
                                        }
                                        i.push(l);
                                        var h;
                                        try {
                                            h = !!window[s[26]]//localStorage, true
                                        } catch (p) {
                                            h = !0
                                        }
                                        if (i.push(h),
                                            i.push(!!window[s[28]]),//indexedDB
                                            G[e[10]] ? i.push(n(G[e[10]][e[52]])) : i.push("undefined"),//e[52]="addBehavior"
                                            i.push(n(window[s[65]])),// openDatabase, "function"
                                            i.push(J[u[146]]),//cpuClass，
                                            i.push(J[s[142]]),//platform，Win32
                                            l = m.i)
                                            try {
                                                var y = G[u[120]](s[66]);//这里是调用一个canvas
                                                l = !(!y[s[171]] || !y[s[171]](e[104]))//这里是判断2d的canvas，用于标记是否能够画一张图，可以直接写死为true
                                            } catch (v) {
                                                l = !1
                                            }
                                        debugger;
                                        if (l)
                                            try {
                                                ...
                                                // i.push(u[12])// u[22]="canvas exception"   可以直接写死即可，即使报错也是写死，也可以写成随机的
                                                var img_b64 = "data:image/png;base64,";
                                                i.push(img_b64)
                                            }
                                        i.push(c()),
                                        m.a && o.push(r()),
                                            o.push(J[s[96]]),//userAgent
                                            o.push(J[u[104]]),//language
                                    ...
                                    // "true###true###true###undefined###function######Win32###data:image/png;base64,###ActiveBorder:rgb(255, 255, 255):ActiveCaption:rgb(204, 204, 204):AppWorkspace:rgb(255, 255, 255):Background:rgb(99, 99, 206):ButtonFace:rgb(240, 240, 240):ButtonHighlight:rgb(221, 221, 221):ButtonShadow:rgb(136, 136, 136):ButtonText:rgb(0, 0, 0):CaptionText:rgb(0, 0, 0):GrayText:rgb(109, 109, 109):Highlight:rgb(0, 120, 215):HighlightText:rgb(255, 255, 255):InactiveBorder:rgb(255, 255, 255):InactiveCaption:rgb(255, 255, 255):InactiveCaptionText:rgb(127, 127, 127):InfoBackground:rgb(251, 252, 197):InfoText:rgb(0, 0, 0):Menu:rgb(247, 247, 247):MenuText:rgb(0, 0, 0):Scrollbar:rgb(255, 255, 255):ThreeDDarkShadow:rgb(102, 102, 102):ThreeDFace:rgb(192, 192, 192):ThreeDHighlight:rgb(221, 221, 221):ThreeDLightShadow:rgb(192, 192, 192):ThreeDShadow:rgb(136, 136, 136):Window:rgb(255, 255, 255):WindowFrame:rgb(204, 204, 204):WindowText:rgb(0, 0, 0)"
                                    // var v1 = "true###true###true###undefined###function######Win32###data:image/png;base64,###ActiveBorder:rgb(255, 255, 255):ActiveCaption:rgb(204, 204, 204):AppWorkspace:rgb(255, 255, 255):Background:rgb(99, 99, 206):ButtonFace:rgb(240, 240, 240):ButtonHighlight:rgb(221, 221, 221):ButtonShadow:rgb(136, 136, 136):ButtonText:rgb(0, 0, 0):CaptionText:rgb(0, 0, 0):GrayText:rgb(109, 109, 109):Highlight:rgb(0, 120, 215):HighlightText:rgb(255, 255, 255):InactiveBorder:rgb(255, 255, 255):InactiveCaption:rgb(255, 255, 255):InactiveCaptionText:rgb(127, 127, 127):InfoBackground:rgb(251, 252, 197):InfoText:rgb(0, 0, 0):Menu:rgb(247, 247, 247):MenuText:rgb(0, 0, 0):Scrollbar:rgb(255, 255, 255):ThreeDDarkShadow:rgb(102, 102, 102):ThreeDFace:rgb(192, 192, 192):ThreeDHighlight:rgb(221, 221, 221):ThreeDLightShadow:rgb(192, 192, 192):ThreeDShadow:rgb(136, 136, 136):Window:rgb(255, 255, 255):WindowFrame:rgb(204, 204, 204):WindowText:rgb(0, 0, 0)"
                                    // var v2 = "Mozilla/5.0 Chrome/84.0.4147.89 Safari/537.36###zh-CN###24###1080x1920###-480######Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf,application/x-google-chrome-pdf~pdf$Chrome PDF Viewer::::application/pdf~pdf$Native Client::::application/x-nacl~,application/x-pnacl~;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"

                                    var rand_str = [Math.floor(Math.random()*256), Math.floor(Math.random()*256), Math.floor(Math.random()*256)].join(",");
                                    // var v1 = "true###true###true###undefined###function######Win32###data:image/png;base64,###ActiveBorder:rgb(255, 255, 255):ActiveCaption:rgb(204, 204, 204):AppWorkspace:rgb(255, 255, 255):Background:rgb(99, 99, 206):ButtonFace:rgb(240, 240, 240):ButtonHighlight:rgb(221, 221, 221):ButtonShadow:rgb(136, 136, 136):ButtonText:rgb(0, 0, 0):CaptionText:rgb(0, 0, 0):GrayText:rgb(109, 109, 109):Highlight:rgb(0, 120, 215):HighlightText:rgb(255, 255, 255):InactiveBorder:rgb(255, 255, 255):InactiveCaption:rgb(255, 255, 255):InactiveCaptionText:rgb(127, 127, 127):InfoBackground:rgb(251, 252, 197):InfoText:rgb(0, 0, 0):Menu:rgb(247, 247, 247):MenuText:rgb(0, 0, 0):Scrollbar:rgb(255, 255, 255):ThreeDDarkShadow:rgb(102, 102, 102):ThreeDFace:rgb(192, 192, 192):ThreeDHighlight:rgb(221, 221, 221):ThreeDLightShadow:rgb(192, 192, 192):ThreeDShadow:rgb(136, 136, 136):Window:rgb(255, 255, 255):WindowFrame:rgb(204, 204, 204):WindowText:rgb("+rand_str+")";
                                    var v1 = "true###true###true###undefined###function######Win32###data:image/png;base64,###ActiveBorder:rgb(255, 255, 255):ActiveCaption:rgb(204, 204, 204):AppWorkspace:rgb(255, 255, 255):Background:rgb(99, 99, 206):ButtonFace:rgb(240, 240, 240):ButtonHighlight:rgb(221, 221, 221):ButtonShadow:rgb(136, 136, 136):ButtonText:rgb(0, 0, 0):CaptionText:rgb(0, 0, 0):GrayText:rgb(109, 109, 109):Highlight:rgb(0, 120, 215):HighlightText:rgb(255, 255, 255):InactiveBorder:rgb(255, 255, 255):InactiveCaption:rgb(255, 255, 255):InactiveCaptionText:rgb(127, 127, 127):InfoBackground:rgb(251, 252, 197):InfoText:rgb(0, 0, 0):Menu:rgb(247, 247, 247):MenuText:rgb(0, 0, 0):Scrollbar:rgb(255, 255, 255):ThreeDDarkShadow:rgb(102, 102, 102):ThreeDFace:rgb(192, 192, 192):ThreeDHighlight:rgb(221, 221, 221):ThreeDLightShadow:rgb(192, 192, 192):ThreeDShadow:rgb(136, 136, 136):Window:rgb(255, 255, 255):WindowFrame:rgb(204, 204, 204):WindowText:rgb(0, 0, 0)";
                                    // var v2 = randomString(parseInt(Math.random() * 5))+"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36###zh-CN###24###1080x1920###-480######Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf
492,141376813,3050360625,654459306,2617837225,1454621731,2489596804,2227061214,1591671054,2362670323,4294967295,1308918612,2246822507,795835527,1181335161,414664567,4279200368,1661365465,1037604311,4150417245,3887607047,1802195444,4023717930,2075208622,1943803523,901097722,628085408,755167117,3322730930,3462522015,3736837829,3604390888,2366115317,0.4,2238001368,2512341634,2647816111,-0.2,314042704,1510334235,900000,58964,1382605366,31158534,450548861,3020668471,1119000684,3160834842,2898065728,1256170817,2765210733,3060149565,3188396048,2932959818,124634137,2797360999,366619977,62317068,-0.26,1202900863,498536548,1340076626,2405801727,2265490386,1594198024,1466479909,2547177864,249268274,2680153253,2125561021,3294710456,855842277,3423369109,0.732134444,3705015759,3569037538,1994146192,1711684554,1852507879,997073096,733239954,4251122042,601450431,4111451223,167816743,3855990285,3988292384,3369554304,3233442989,3495958263,3624741850,65535,453092731,-0.9,2094854071,1957810842,325883990,4057260610,1684777152,4189708143,3915621685,162941995,1812370925,3775830040,783551873,3134207493,1172266101,2998733608,2724688242,1303535960,2852801631,112637215,1567103746,651767980,1426400815,906185462,2211677639,1047427035,2344532202,2607071920,2466906013,225274430,544179635,2176718541,2312317920,1483230225,1342533948,2567524794,2439277719,1088359270,671266974,1219638859,840000,953729732,3099436303,2966460450,817233897,2685067896,2825379669,4089016648,4224994405,3943577151,3814918930,476864866,1634467795,335633487,1762050814,1,2044508324,-1,3401237130,3268935591,3524101629,3663771856,1907459465]
                                var n, i, r, o, a, s, u = 31;//u = t[82]
                                for (n = e.length & 3,
                                         i = e.length - n,
                                         r = u,
                                         u = 3432918353,//t[15]
                            ...
                            function x(i) {//这个操作是等于将 对象i，转换为字符串i，比如：{'v':'v1.1','fp':'25662623634134,7139997656248','u':'D181595319310996V4r','h':'dun.163.com'} 转换为 "{'v':'v1.1','fp':'25662623634134,7139997656248','u':'D181595319310996V4r','h':'dun.163.com'}"
                            ...
                            function W() {
                                ...
                                try {
                                    ...
                                    // c([120, 41, 62, -96], 0, [], 0, 4);//E就是前面生成的参数，可以写死，因为是随机生成的：本地生成：[-128, -127, -127, -128]；浏览器生成：[120, 41, 62, -96]
                            ...
                            var z = [new R(s[54],l[13]), new R(e[81],l[14]), new R(e[117],l[11]), new R(s[52],l[12]), new R(s[126],l[10]), new R(e[9],l[9]), new R(l[2],l[20]), new R(u[188],l[23]), new R(s[105],l[6]), new R(s[76],s[151]), new R(s[45],s[149]), new R(e[71],s[150]), new R(s[166],s[146]), new R(s[4],s[148]), new R(s[18],s[143]), new R(e[93],s[145]), new R(s[159],s[152]), new R(u[124],s[155]), new R(e[5],s[114],!1), new R(e[46],s[115],!1), new R(u[121],s[112],!1), new R(e[62],s[113],!1), new R(e[17],s[131],!1)]
                                ...
                                , ue = e[114]
                                , fe = t[87]
                                , ce = e[27]// e[27]="aZbY0cXdW1eVf2Ug3Th4SiR5jQk6PlO7mNn8MoL9pKqJrIsHtGuFvEwDxCyBzA"
                                , je = ce.length//62
                                , de = t[428]//900000
                                , he = t[520]//840000
                                , pe = false
