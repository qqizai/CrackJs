window.NECaptcha = function(e) {
                ...
                try {
                    ...
                    if (c) {
                        ...
                        if (m) {
                            if ("end" !== R)
                                return;
                            var C = g || b.getEntriesByName(h && h._originUrl || i)[0];
                            if (!C)
                                return;
                            e.collect(n, T, {
                                tc: a(C.responseEnd - (C.domainLookupStart || C.connectStart), 1),
                                dc: a(C.domainLookupEnd - C.domainLookupStart, 1),
                                cc: a(C.connectEnd - C.connectStart, 1),
                                rc: a(C.responseStart - C.requestStart, 1),
                                rr: a(C.responseEnd - C.responseStart, 1),
                                url: i,
                                host: w.host,
    ...
    , function(e, t, n) {
        ...
        e.exports = {
            ...
            mounted: function() {
                var e = this;
                p(this.$store.state.config.customStyles.primaryColor, this.$el, this.enableColor);
                ...
                a.on(this.appendTo ? n : document, "click", this.bodyCloseModalFn),
                    ...
                    this._unsubscribe = this.$store.subscribe(function(t, n) {
                        var i = t.type;
                        i === u && "success" === n.verifyStatus && window.setTimeout(function() {
                            e.close()
                        }, 500)
                    }),
            ...
            methods: {
                ...
                bodyCloseModal: function(e) {
                    ...
                    t && t.search(/yidun/g) > -1 || this.close(h.USER)
                },
                close: function(e) {
                    this.$store.state.config.enableClose || this.closeModal(e)
                },
                closeModal: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : h.PROCESS;
                    this._isMounted && "none" !== this.$el.style.display && (this.$store.state.config.enableClose && (e = h.CLOSE),
                        this.curCloseSource = e,
            ...
            methods: {
                ...
                trackMoving: function(e) {
                    if (this.beginTime) {
                        ...
                        console.log([e.clientX - n, e.clientY - i, s.now() - this.beginTime])
                    }
    ...
    , function(e, t, n) {
        ...
        e.exports = {
            ...
            mounted: function() {
                var e = this;
                C(this.$store.state.config.customStyles.primaryColor, this.$el),
                    this.beginTime = 0,
                    this.traceData = [],
                    this._baseClassNames = this.$el.className.trim(),
                    this._removeEvents = this.initEvents(),
                    ...
                    !function() {
                        ...
                        function _(e) {
                            ...
                            try {
                                ...
                                d = d == t[9] ? t[535] : d,
                                    f = w(j * t[535] / d, Q);
                                for (var v, g = Math.floor(f / Math.pow(t[37], Q - t[535])), b = e + l[0], m = t[9], _ = t[9], E = t[9], R = t[9], C = t[9]; C < b.length; C++)
                                    try {
                                        var k = parseInt(b.charAt(C) + l[0]);
                                        k || k === t[9] ? k < g ? (_++,
                                            m += k) : (R++,
                                            E += k) : (R++,
                                            E += g)
                            ...
                            try {
                                ...
                                for (var K = X.length, G = t[9]; G < K; G++) {
                                    ...
                                    null == F)
                                        ...
                                        for (var z = [], Ee = U.length, Re = t[9], Ce = F.length; Re < Ce; Re++)
                                            z[Re] = b(F[Re] + U[Re % Ee]);
                                        Te = z
                                    }
                                    var Se = y(Te, k)
                ...
                i(u, w, function(e, t) {
                    ...
                    n(p, {
                        ...
                        f(C, R, function(e, t) {
                            ...
                            a(null, t);
                            var s = t.data;
                            s.type !== k.INTELLISENSE && s.type !== i.captchaType && n(d, {
                                captchaType: s.type,
