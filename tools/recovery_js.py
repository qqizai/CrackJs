...
"""
    result = utf16_decode(js_code=js_code)
    print(result)
    # js_code = """window['\x61\x64\x64\x45\x76\x65\x6e\x74\x4c\x69\x73\x74\x65\x6e\x65\x72']"""
    # print(js_code.encode().decode(encoding="utf-8"))
    pass