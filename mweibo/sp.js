...
function get_sp(pubkey, server_time, nonce, user_name) {
    ...
    // var server_time = 1577167779;
    // var nonce = "Q9ANUY";
    // var user_name = "abc123456";
    var f = new sinaSSOEncoder.RSAKey;
    f.setPublic(pubkey, "10001");// f.setPublic(me.rsaPubkey, "10001");
    // b = f.encrypt([me.servertime, me.nonce].join("\t") + "\n" + b);
    b = f.encrypt([server_time, nonce].join("\t") + "\n" + user_name);
    console.log(b);
    return b;
}
...
get_sp(pubkey, server_time, nonce, user_name);
